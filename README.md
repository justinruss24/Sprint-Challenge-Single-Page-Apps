...
> Answer: Client side routing provides a better user experience and allows you to reload the page without a server request. The entire new component loads on the get request.
